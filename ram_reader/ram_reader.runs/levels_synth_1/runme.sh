...
HD_PWD='C:/DATA/2024/7mo semestre/SEP/Proyectos/ram_reader/ram_reader.runs/levels_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log levels.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source levels.tcl
