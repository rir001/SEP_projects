...
HD_PWD='C:/Users/gusta/Documents/SEP_projects/SM/SM.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SM.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SM.tcl -notrace
