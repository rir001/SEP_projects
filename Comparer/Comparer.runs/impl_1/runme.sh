...
HD_PWD='C:/Users/gusta/Documents/SEP_projects/Comparer/Comparer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Comparer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Comparer.tcl -notrace
