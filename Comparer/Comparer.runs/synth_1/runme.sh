...
HD_PWD='C:/Users/gusta/Documents/SEP_projects/Comparer/Comparer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Comparer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Comparer.tcl
