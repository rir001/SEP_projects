...
HD_PWD='C:/Users/gusta/OneDrive/Documents/universidad/4to/1r/SEP/Proyectos/pr1/init_axi/init_axi.runs/design_1_vio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_vio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_vio_0_2.tcl
