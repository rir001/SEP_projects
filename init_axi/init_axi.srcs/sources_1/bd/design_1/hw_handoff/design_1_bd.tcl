...
proc create_root_design { parentCell } {
  ...
  set rgb [ create_bd_port -dir O rgb ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ATG_SYSTEM_INIT_ADDR_MIF {../../../../../../../init_coe_files/addr.coe} \
   CONFIG.C_ATG_SYSTEM_INIT_CTRL_MIF {../../../../../../../init_coe_files/ctrl.coe} \
   CONFIG.C_ATG_SYSTEM_INIT_DATA_MIF {../../../../../../../init_coe_files/data.coe} \
   CONFIG.C_ATG_SYSTEM_INIT_MASK_MIF {../../../../../../../init_coe_files/mask.coe} \
 ] $axi_traffic_gen_0
  ...
  connect_bd_net -net Init_0_leds [get_bd_ports leds] [get_bd_pins Init_0/leds]
  connect_bd_net -net Init_0_rgb [get_bd_ports rgb] [get_bd_pins Init_0/rgb]
  connect_bd_net -net clk_0_1 [get_bd_ports clk] [get_bd_pins Init_0/clk] [get_bd_pins clk_wiz/clk_in1] [get_bd_pins vio_0/clk]
  connect_bd_net -net clk_wiz_clk_out1 [get_bd_pins Init_0/s00_axi_aclk] [get_bd_pins axi_traffic_gen_0/s_axi_aclk] [get_bd_pins clk_wiz/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  ...
  connect_bd_net -net sm_state_0_1 [get_bd_ports sw] [get_bd_pins Init_0/sm_state]
