...
HD_PWD='C:/DATA/2024/sem07/SEP/SEP_projects/memorice/memorice.runs/design_1_state_machine_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_state_machine_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_state_machine_0_0.tcl
