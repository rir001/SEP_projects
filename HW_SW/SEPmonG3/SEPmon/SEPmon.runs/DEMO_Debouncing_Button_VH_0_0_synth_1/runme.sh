...
HD_PWD='C:/Users/gusta/Documents/SEP_projects/HW_SW/SEPmonG3/SEPmon/SEPmon.runs/DEMO_Debouncing_Button_VH_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_Debouncing_Button_VH_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_Debouncing_Button_VH_0_0.tcl
