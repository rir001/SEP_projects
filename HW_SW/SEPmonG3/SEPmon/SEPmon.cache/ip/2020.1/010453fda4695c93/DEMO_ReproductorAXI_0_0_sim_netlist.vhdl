...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ReproductorAXI_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \BUZZER_PWM1_carry__0_i_11\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \BUZZER_PWM1_carry__0_i_12\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \BUZZER_PWM1_carry__0_i_14\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \BUZZER_PWM1_carry__0_i_9\ : label is "soft_lutpair0";
...
\BUZZER_PWM1_carry__0_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\BUZZER_PWM1_carry__0_i_10\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"A0C0"
    )
        port map (
...
\BUZZER_PWM1_carry__0_i_5\: unisim.vcomponents.LUT6
    generic map(
...
\BUZZER_PWM1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 2) => B"00",
      S(1) => \BUZZER_PWM1_carry__1_i_1_n_0\,
      S(0) => \BUZZER_PWM1_carry__1_i_2_n_0\
    );
\BUZZER_PWM1_carry__1_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\BUZZER_PWM1_carry__1_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
