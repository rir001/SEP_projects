...
##Buttons
#set_property -dict { PACKAGE_PIN K18   IOSTANDARD LVCMOS33 } [get_ports { AD_tri_o }]; #IO_L12N_T1_MRCC_35 Sch=btn[0]
#set_property -dict { PACKAGE_PIN P16   IOSTANDARD LVCMOS33 } [get_ports { RST_tri_io[1] }]; #IO_L24N_T3_34 Sch=btn[1]
...
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33     } [get_ports { In0 }]; #IO_L11N_T1_SRCC_34 Sch=jd_n[3]            
