...
HD_PWD='C:/Users/gusta/OneDrive/Escritorio/SEPmon/SEPmon.runs/DEMO_xbar_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DEMO_xbar_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DEMO_xbar_1.tcl
